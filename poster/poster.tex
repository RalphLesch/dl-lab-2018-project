...
\headerbox{4. Augmentations}{name=augmentations,span=2,column=1,below=introduction}{ % To reduce this block to 1 column width, remove 'span=2'
...
\headerbox{5. Results}{name=results,span=2,column=1,below=augmentations}{ % To reduce this block to 1 column width, remove 'span=2'
