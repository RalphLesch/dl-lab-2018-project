...
\headerbox{2. General Setting}{name=setting,column=0,below=introduction,span=1}{
...
\begin{itemize}
    ...
    \item \textbf{Shape Augmentation} with different geometric translations and dropouts (Horizontal Flip, Scaling, Crop and Padding, rectangular Cutouts)
    \item \textbf{Color Augmentation} by varying intensity of pixel values (Adjustment of Brightness and Contrast, Color shifts)
...
\headerbox{3. Similarity measure}{name=mcs,column=0,below=setting,span=1}{
