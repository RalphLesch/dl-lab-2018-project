...
\begin{wrapfigure}{l}{0.58\textwidth}
    \begin{center}
        \includegraphics[width=0.9\linewidth]{prediction.pdf}
        \caption{ Images and predicted segmentation maps of the test dataset. From left: original image and segmentation map, predicted segmentation maps of the CNN without augmentation, with shape, with color and with shape \& color augmentation.}
    \end{center}
\end{wrapfigure}
